...
@section('content')
    <section class="max-w-3xl">
        ...
        <h1 class="text-4xl font-semibold tracking-normal text-white">Tambah Note</h1>
        <p class="mt-4 text-zinc-300">Form ini dikirim ke controller milik package dan disimpan ke tabel `tes_package_notes`.</p>
    </section>

    <form method="POST" action="{{ route('tes-package.notes.store') }}" class="mt-10 max-w-3xl space-y-6">
        @csrf

        @include('tes-package::notes.partials.form', ['note' => null])
